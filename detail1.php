...
// แปลงข้อมูล JSON ให้เป็นอ็อบเจ็กต์
$content = json_decode($content);

foreach($content->result as $jobDetails):
...
<main class="col-lg-8 col-md-6 container my-4">
    <section class="mx-4 mb-4">
        ...
        <ul class="list-unstyled">
            ...
            <li><i class="bi bi-coin me-4 fs-3" style="color: #228CC1;"></i><span style="font-size: 1.2rem;"><?php echo $jobDetails->salary ? $jobDetails->salary : 'N/A'; ?> THB</span></li>
    ...
    <section class="mx-4 mb-4">
        ...
        <ul class="fs-5">
            <li><?php echo nl2br($jobDetails->job_property); ?></li>
        </ul>
    </section>
    ...
    <section class="mx-4 mb-4">
        ...
        <ul class="fs-5">
            <li><?php echo nl2br($jobDetails->welfare); ?></li>
        </ul>
    </section>
    ...
    <section class="mx-4 mb-4">
        ...
        <!-- ใช้ URL ที่ไม่ซ้ำกันด้วย postjob_id หรือ job_id -->
        <a href="#" class="btn btn-primary">สมัครงาน</a>
    </section>
</main>
